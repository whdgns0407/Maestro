		...
		<div class="container-fluid">
			<div id="frame" class="col-md-10 col-md-offset-2 main">
				<?php
					...
					{
				?>
					<iframe src="./page/board/read.php?idx=<?php echo $_GET['idx'] ; ?>" style="width:100%; height:100%" name="cont" ></iframe>
				<?php
					}
					else
					{
				?>
					<iframe src="./notice.php" style="width:100%; height:100%" name="cont" ></iframe>
