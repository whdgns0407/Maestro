	...
	<body>
		<div id="board_area"> 
			...
			<h1>
				...
				?>		
				에서 '<?php echo $search_con1; ?>'검색결과 
			</h1>
			<h4 style="margin-top:30px;"><a href="../../../notice/notice.php">공지사항 바로가기</a></h4>
			<table class="list-table">
				...
				<?php
					$sql2 = mysql_query("select * from notice where $catagory like '%$search_con%' order by idx desc");
					...
					$sql3 = mysql_query("select * from notice_reply where con_num='".$board['idx']."'");
