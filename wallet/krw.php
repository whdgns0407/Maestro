...
<html>
	...
	<body>
		<nav>
			...
			<img width="40px" height="40px" src="krw.png" alt="원화">
			<a href="./deposit/krw.php" target="cont_a">  충전</a>
			<a href="./withdraw/krw.php" target="cont_a">출금</a>
			<a href="./history/krw_inout.php" target="cont_a">내역</a>
			<iframe name="cont_a" width="100%" height="850px" src="./deposit/krw.php"></iframe>
			</font>
		</nav>
	</body>
</html>
